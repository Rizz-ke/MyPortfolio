        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="card__content flex flex-col items-center justify-center p-6 bg-purple-900 rounded-lg h-full">
              ...
              {/* Video icons */}
              <div className="flex justify-center space-x-4 mt-4">
                <a href="https://vimeo.com/980524660" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white flex items-center">
                ...
                <a href="https://vimeo.com/980526478?activityReferer=1" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white flex items-center">
                  <FaVideo className="text-5xl text-red-600 hover:text-red-500 cursor-pointer" />
                  <AiFillPlayCircle className="text-6xl ml-2 text-red-400 hover:text-red-300" /> {/* Fancier play icon */}
                </a>
                <a href="https://vimeo.com/980524997" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white flex items-center">
                  <FaVideo className="text-5xl text-red-600 hover:text-red-500 cursor-pointer" />
                  <AiFillPlayCircle className="text-6xl ml-2 text-red-400 hover:text-red-300" /> {/* Fancier play icon */}
                </a>
          ...
          >
            ...
            <div className="card__content flex flex-col items-center justify-center p-6 bg-purple-900 rounded-lg h-full">
              ...
              {/* Video icons */}
              <div className="flex justify-center space-x-4 mt-4">
                <a href="https://vimeo.com/980734148" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white flex items-center">
                  <FaVideo className="text-5xl text-red-600 hover:text-red-500 cursor-pointer" />
                  <AiFillPlayCircle className="text-6xl ml-2 text-red-400 hover:text-red-300" /> {/* Fancier play icon */}
                </a>
                <a href="https://vimeo.com/980526478?activityReferer=1" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white flex items-center">
